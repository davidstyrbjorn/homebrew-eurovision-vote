...
const bgGradient1 = {
	background:
		"linear-gradient(90deg, rgba(101,42,179,1) 0%, rgba(254,71,222,1) 20%, rgba(101,42,179,1) 100%)",
};
const bgGradient2 = {
	background:
		"linear-gradient(90deg, rgba(101,42,179,1) 0%, rgba(254,71,222,1) 35%, rgba(101,42,179,1) 100%)",
};
const bgGradient3 = {
	background:
		"linear-gradient(90deg, rgba(101,42,179,1) 0%, rgba(254,71,222,1) 50%, rgba(101,42,179,1) 100%)",
};
const bgGradient4 = {
	background:
		"linear-gradient(90deg, rgba(101,42,179,1) 0%, rgba(254,71,222,1) 65%, rgba(101,42,179,1) 100%)",
};
const bgGradient5 = {
	background:
		"linear-gradient(90deg, rgba(101,42,179,1) 0%, rgba(254,71,222,1) 80%, rgba(101,42,179,1) 100%)",
};
...
const textStyle = {
	background:
		"linear-gradient(211deg, rgba(223,29,197,1) 0%, rgba(255,233,70,1) 7%, rgba(241,52,226,1) 68%, rgba(223,131,29,1) 100%)",
	WebkitBackgroundClip: "text",
	WebkitTextFillColor: "transparent",
};
...
const Entry: React.FC<EntryProps> = ({ participant, id }) => {
	...
	return (
		<Box
			sx={{
				...containerStyle,
				...gradientList[id % gradientList.length],
				flexDirection: "row",
...
const EntryList: React.FC = () => {
	...
	const [previouslyPlayedParticipants, setPreviouslyPlayedParticipants] =
	...
	return (
		<Box sx={{ minHeight: "60vh" }}>
			{previouslyPlayedParticipants.map(
